...
@interface TipVC () <UITextFieldDelegate>
...
- (void)viewDidLoad {
    ...
    UIImage *highlightImage = [UIImage imageNamed:@"下一步_置灰"];
...
- (void)showTipWithTitle:(NSString *)title
    ...
    [_cancelBtn setBackgroundColor:UIColorFromRGB(0xf07533)];
...
- (void)showTipWithTitle:(NSString *)title
    ...
    _tipBGView.frame = CGRectMake(20, 133 + 20, self.view.frame.size.width - 40, 261);
    
    _titleLabel.frame = CGRectMake(0, 20, _tipBGView.frame.size.width, 17);
    _titleLabel.text = title;
    _titleLabel.textAlignment = NSTextAlignmentCenter;
    orangeView.frame = CGRectMake(0, 48.5, _tipBGView.frame.size.width, 0.5);
    orangeView.backgroundColor = UIColorFromRGB(0xf07533);
    [_tipBGView addSubview:orangeView];
    
    moneyLabel = [[UILabel alloc] init];
    moneyLabel.frame = CGRectMake(0, 71, _tipBGView.frame.size.width, 24);
    ...
    //购买产品
    _contentLabel.frame = CGRectMake(20, 112.5, _tipBGView.frame.size.width - 40, 35);
    _contentLabel.text = content;
    ...
    textTradeField = [[UITextField alloc]
                      initWithFrame:CGRectMake(20, 151, _tipBGView.frame.size.width - 40, 35)];
...
-(void)isResignFirstResponder
{
    ...
    _tipBGView.frame = CGRectMake(20,(M_HEIGHT-261)/2, M_WIDTH - 40, 261);
...
- (void)textFieldDidBeginEditing:(UITextField *)textField {
    ...
    _tipBGView.frame= CGRectMake(20,(M_HEIGHT-261)/2-50, M_WIDTH - 40, 261);
    [UIView commitAnimations]; //提交动画
}
